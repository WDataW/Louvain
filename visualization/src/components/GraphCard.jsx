        ...
        <div className="min-h-full grid grid-cols-1 px-[1rem] py-[0.7rem] text-start border border-[rgba(255,255,255,0.4)]  rounded-[1rem]">
            <div className={`text-start`} {...props}>
                ...
                <div className="ps-[0.5rem] flex flex-col gap-[0.5rem]">
                    <h1 className="capitalize text-[#FFC000] text-[1.2rem] font-bold ">{title}</h1>
            ...
            <NavLink to={`visualize/${dirName}`} className={"block text-center h-[2.75rem] self-end mt-[1rem] mb-[0.2rem] p-[0.5rem] w-full border hover:bg-[#FFC000] hover:text-black transition border-[#FFC000] rounded-[0.5rem]"}>Explore</NavLink>
        </div>
    );
}